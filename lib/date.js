...
class KarmiaUtilityDate {
    ...
    format(format, date) {
        ...
        return format.split('').map(function (value) {
            if ('d' === value) {
                return string.zfill(date.getDate(), 2);
            } else if ('D' === value) {
                ...
                return string.zfill(date.getMonth() + 1, 2);
            } else if ('M' === value) {
                ...
                return string.zfill((date.getHours() > 12) ? date.getHours() - 12 : date.getHours(), 2);
            } else if ('H' === value) {
                return string.zfill(date.getHours(), 2);
            } else if ('i' === value) {
                return string.zfill(date.getMinutes(), 2);
            } else if ('s' === value) {
                return string.zfill(date.getSeconds(), 2);
            } else if ('u' === value) {
                return string.zfill(date.getMilliseconds() * 1000, 6);
            } else if ('O' === value) {
